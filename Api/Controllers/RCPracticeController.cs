...
namespace Api.Controllers
{
    ...
    public class RCPracticeController : ControllerBase
    {
        ...
        [Authorize(policy: "MillerSurnamelPolicy")]
        public IActionResult MillerSurnamelPolicy()
        {
            return Ok("miller surname policy");
        }

        [HttpGet("manager-email-and-wilson-surname-policy")]
        [Authorize(policy: "ManagerEmailAndWilsonSurnamelPolicy")]
        public IActionResult ManagerEmailAndWilsonSurnamelPolicy()
        {
