...
// be able to inject JWTSrvice class inside our Controllers
...
builder.Services.AddIdentityCore<User>(options =>
{
    ...
    options.SignIn.RequireConfirmedEmail = true;
     ...
     .AddUserManager<UserManager<User>>() // make use of UserManager to create
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            // validatee the issuer (who ever is issuing the JWT)
            ValidateIssuer = true,
...
builder.Services.AddAuthorization(opt =>
{
    ...
    opt.AddPolicy("MillerSurnamelPolicy", policy => policy.RequireClaim(ClaimTypes.Surname, "miller"));

    opt.AddPolicy("ManagerEmailAndWilsonSurnamelPolicy", policy => policy.RequireClaim(ClaimTypes.Surname, "wilson")
